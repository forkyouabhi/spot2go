    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FFF8DC' }}>
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <h1 className="font-semibold" style={{ color: '#FFF8DC' }}>My Account</h1>
        </div>
        <Button 
          variant="ghost" 
          size="sm" 
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="flex items-center mt-2 text-xs" style={{ color: '#DC6B19' }}>
            ...
            >
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center gap-3" style={{ color: '#6C0345' }}>
                  ...
                  >
                    <Calendar className="h-4 w-4" style={{ color: '#6C0345' }} />
                  </div>
                  Upcoming Bookings
                </CardTitle>
              </CardHeader>
              <CardContent>
                {upcomingBookings.length > 0 ? (
                  <div className="space-y-4">
                    {upcomingBookings.map((booking, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between text-sm" style={{ color: '#6C0345' }}>
                          <div className="flex items-center space-x-2">
                            <Calendar className="h-4 w-4" style={{ color: '#DC6B19' }} />
                  ...
                  <div className="text-center py-12">
                    ...
                    >
                      <Calendar className="h-8 w-8" style={{ color: '#6C0345' }} />
                    </div>
                    ...
                    {pastBookings.map((booking, index) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            <h4 className="font-medium" style={{ color: '#6C0345' }}>
                              {booking.placeName}
                            </h4>
                            <Badge 
                        ...
                        <div className="flex items-center space-x-4 text-sm" style={{ color: '#6C0345' }}>
            ...
            >
              <CardContent className="p-8">
                <div className="text-center py-12">
                  ...
                  >
                    <Bookmark className="h-8 w-8" style={{ color: '#6C0345' }} />
                  </div>
                  <p className="font-semibold" style={{ color: '#6C0345' }}>
