...
import { ArrowLeft, MapPin, BookOpen, Users, Sparkles, Mail, Loader2 } from "lucide-react";
...
export function AuthForm({ type, onSubmit, onThirdPartyAuth, onBack }: AuthFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      toast.success(`Successfully ${type === 'login' ? 'signed in' : 'created account'}!`);
  ...
  const handleThirdPartyAuth = async (provider: 'google' | 'apple') => {
    ...
    try {
      ...
      onThirdPartyAuth(provider, mockUserData);
    } catch (error) {
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          >
            ...
            <CardContent className="space-y-6">
                  ...
                  <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span 
                        ...
                        style={{ backgroundColor: '#FFF8DC', color: '#6C0345' }}
                      >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  {type === 'signup' && (
                    <div className="space-y-2">
                      <Label htmlFor="name" className="font-medium" style={{ color: '#6C0345' }}>
                        Full Name
                      </Label>
                      <Input
                        id="name"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email" className="font-medium" style={{ color: '#6C0345' }}>
                      Email Address
                    </Label>
                    <Input
                      id="email"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="password" className="font-medium" style={{ color: '#6C0345' }}>
                      Password
                    </Label>
                    <Input
                      id="password"
              ...
              {!showEmailForm && (
                <div className="pt-6 border-t-2" style={{ borderColor: '#F7C566' }}>
                  <p className="text-center text-sm mb-4" style={{ color: '#6C0345' }}>
                    What you'll get:
                  </p>
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div className="space-y-2">
                      ...
                      >
                        <MapPin className="h-5 w-5" style={{ color: '#6C0345' }} />
                      </div>
                      <p className="text-xs" style={{ color: '#6C0345' }}>Find Spots</p>
                    </div>
                    <div className="space-y-2">
                      <div 
                        className="w-10 h-10 rounded-xl flex items-center justify-center mx-auto border-2"
                      ...
                      >
                        <BookOpen className="h-5 w-5" style={{ color: '#6C0345' }} />
                      </div>
                      <p className="text-xs" style={{ color: '#6C0345' }}>Book Easily</p>
                    </div>
                    <div className="space-y-2">
                      <div 
                        className="w-10 h-10 rounded-xl flex items-center justify-center mx-auto border-2"
                      ...
                      >
                        <Users className="h-5 w-5" style={{ color: '#6C0345' }} />
                      </div>
                      <p className="text-xs" style={{ color: '#6C0345' }}>Join Community</p>
                    </div>
                  </div>
                </div>
              )}
