...
export const mockPlaces: StudyPlace[] = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Perfect spot for studying! Great coffee and very quiet.",
        date: "2025-09-20",
      },
      {
        id: "2",
        ...
        rating: 4,
        comment:
          "Good atmosphere, but can get busy during exam season.",
        date: "2025-09-18",
      },
    ],
  },
  {
    ...
    description:
      "Modern library with dedicated study spaces and extensive resources.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Excellent facilities and always quiet. Perfect for serious studying.",
        date: "2025-09-19",
      },
    ],
  },
  {
    ...
    description:
      "Modern co-working space with flexible seating and professional atmosphere.",
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Great for professional work. A bit pricey but worth it.",
        date: "2025-09-17",
      },
    ],
  },
  {
    ...
    description:
      "University study hall open to the public with great facilities.",
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Good facilities, but can get crowded during exam periods.",
        date: "2025-09-16",
      },
    ],
  },
