...
"[project]/src/lib/api.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getPlaces = ()=>api.get('/customers/places');
const getPlaceById = (id)=>api.get("/customers/places/".concat(id)); // Example for a future details page
const createBooking = (bookingData)=>api.post('/customers/bookings', bookingData);
const getUserBookings = ()=>api.get('/customers/bookings');
const getOwnerPlaces = ()=>api.get('/owners/places');
const createPlace = (placeData)=>api.post('/owners/places', placeData);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api.js [client] (ecmascript)");
...
const AuthProvider = (param)=>{
            ...
            if (token) {
                try {
                    ...
                    if (decoded && typeof decoded.exp === 'number' && decoded.exp * 1000 > Date.now()) {
                        setUser(decoded);
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["setAuthToken"])(token);
                    } else {
    ...
    const login = async (email, password)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["loginUser"])({
            email,
            password
        });
    ...
    const register = async (name, email, password)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["registerUser"])({
            name,
            email,
            password,
            role: 'customer'
    ...
    const logout = ()=>{
        localStorage.removeItem('token');
        setUser(null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["setAuthToken"])(null);
        router.push('/login');
    };
...
"[project]/src/components/ui/sonner.tsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sonner$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/sonner.tsx [client] (ecmascript)");
;
;
;
;
function App(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sonner$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["Toaster"], {}, void 0, false, {
                fileName: "[project]/src/pages/_app.tsx",
                lineNumber: 9,
                columnNumber: 7
            }, this)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9019ebd0._.js.map