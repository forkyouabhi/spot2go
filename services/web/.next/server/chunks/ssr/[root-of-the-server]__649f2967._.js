...
const getPlaceById = (id)=>api.get(`/customers/places/${id}`); // Example for a future details page
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$jwt$2d$decode__$5b$external$5d$__$28$jwt$2d$decode$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
const AuthProvider = ({ children })=>{
        ...
        if (token) {
            try {
                ...
                if (decoded && typeof decoded.exp === 'number' && decoded.exp * 1000 > Date.now()) {
                    setUser(decoded);
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["setAuthToken"])(token);
                } else {
    ...
    const login = async (email, password)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["loginUser"])({
            email,
            password
        });
    ...
    const register = async (name, email, password)=>{
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["registerUser"])({
            name,
            email,
            password,
            role: 'customer'
    ...
    const logout = ()=>{
        localStorage.removeItem('token');
        setUser(null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["setAuthToken"])(null);
        router.push('/login');
    };
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sonner$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__649f2967._.js.map